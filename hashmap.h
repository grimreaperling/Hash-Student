...
public:
    ...
    */
    ...
    /* 
     * We implement a const version of the at method to return the const reference.
     */
    ...
    */
    ...
    /* 
     * A const version of the find method which return a const iterator.
     */
    ...
    */
    ...
    /*
     * Add a const version of the end function.
     */
    ...
    */
    ...
    /*
     * Move constructor initialize 
     * the move constructor get the content from the parameter.
     */
    HashMap(HashMap&& other);

    /*
     * Move assignment
     * get the content from the rhs operator.
     */
