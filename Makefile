#############################################################################
# Makefile for building: HashMap.app/Contents/MacOS/HashMap
# Generated by qmake (3.1) (Qt 6.3.2)
# Project:  HashMap.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile HashMap.pro
#############################################################################
...
DEFINES       = -Dmain=qMain -DqMain=studentMain -DQT_WIDGETS_LIB -DQT_MULTIMEDIA_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -g $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12 -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -g -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12 -Wall -Wextra -Werror=return-type -Werror=uninitialized -Wunused-parameter -Wmissing-field-initializers -Wno-old-style-cast -Wno-sign-compare -Wno-sign-conversion -Wno-unused-const-variable -Wempty-init-stmt -Wignored-qualifiers -fPIC $(DEFINES)
INCPATH       = -I. -I. -I../../../Library/Application\ Support/cs106/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtMultimedia.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = HashMap1.0.0
DISTDIR = /Users/weierstrasseinstein/Downloads/Datastructure/HashMap/.tmp/HashMap1.0.0
LINK          = @echo linking $@ && /Library/Developer/CommandLineTools/usr/bin/clang++
LFLAGS        = -L'/Users/weierstrasseinstein/Library/Application Support/cs106/lib' -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/opt/homebrew/lib
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -lcs106 -lpthread -framework QtWidgets -framework QtMultimedia -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtNetwork -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
EXPORT__QMAKE_STASH_ = /Users/weierstrasseinstein/Downloads/Datastructure/HashMap/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/weierstrasseinstein/Downloads/Datastructure/HashMap/HashMap.pro
...
HashMap.app/Contents/MacOS/HashMap: /Users/weierstrasseinstein/Library/Application\ Support/cs106/lib/libcs106.a $(OBJECTS)  
	@test -d HashMap.app/Contents/MacOS/ || mkdir -p HashMap.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: HashMap.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.3.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.3.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.3.2/share/qt/mkspecs/common/macx.conf \
...
HashMap.app/Contents/PkgInfo: 
	@test -d HashMap.app/Contents || mkdir -p HashMap.app/Contents
	@$(DEL_FILE) HashMap.app/Contents/PkgInfo
	@echo "APPL????" > HashMap.app/Contents/PkgInfo
HashMap.app/Contents/Resources/empty.lproj: 
	@test -d HashMap.app/Contents/Resources || mkdir -p HashMap.app/Contents/Resources
	@touch HashMap.app/Contents/Resources/empty.lproj
	
HashMap.app/Contents/Info.plist: 
	@test -d HashMap.app/Contents || mkdir -p HashMap.app/Contents
	@$(DEL_FILE) HashMap.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.HashMap,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.HashMap,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,HashMap,g" -e "s,@LIBRARY@,HashMap,g" -e "s,\$${EXECUTABLE_NAME},HashMap,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app >HashMap.app/Contents/Info.plist

all: Makefile \
		HashMap.app/Contents/PkgInfo \
		HashMap.app/Contents/Resources/empty.lproj \
		HashMap.app/Contents/Info.plist HashMap.app/Contents/MacOS/HashMap
...
/Users/weierstrasseinstein/Library/Application\ Support/cs106/lib/libcs106.a:
	$(error CS106 library not found. See http://cs106b.stanford.edu/qt for library install instructions)
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	@echo generating ./moc_predefs.h
	@/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -g -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=12 -Wall -Wextra -Werror=return-type -Werror=uninitialized -Wunused-parameter -Wmissing-field-initializers -Wno-old-style-cast -Wno-sign-compare -Wno-sign-conversion -Wno-unused-const-variable -Wempty-init-stmt -Wignored-qualifiers -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
